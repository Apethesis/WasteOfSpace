...
elements["coordActionBox"] = screen:CreateElement("TextLabel", { Size = UDim2.new(0.8,0,1,0), Position = UDim2.new(0.2,0,0,0), TextScaled = true, Font = Enum.Font.Nunito, PlaceholderColor3 = Color3.fromRGB(255,255,255), Text = "Coordinates", TextColor3 = Color3.fromRGB(255,255,255) }) elements.coordAction:AddChild(elements.coordActionBox) newvar = elements.coordActionBox
if hyperdrive then
